...
export class RegionService {
  ...
  getRegions(): Region[]{
    ...
    region = new Region(1, "Noreste", "NE", 0); regions.push(region);
    region = new Region(1, "Pacífico", "P", 0); regions.push(region);
    region = new Region(1, "Oeste", "O", 1); regions.push(region);
    region = new Region(1, "Sureste", "SE", 0); regions.push(region);
    return regions;
  }
